...
learning_rates = [1e-3, 1e-4, 1e-5, 2e-3, 2e-5, 3e-5, 4e-5, 5e-5]
weight_decay_values = [0.0001, 0.001, 0.01, 0.1, 0.2, 0.3, 0.4]
dropout_rates = [0.01, 0.05, 0.1, 0.15, 0.2, 0.3, 0.4]
...
for i in learning_rates:
    for j in weight_decay_values:
        for k in dropout_rates:
            ...
            classifier_optimizer = AdamW(model.classifier.parameters(), lr=i)
            ...
            acc = test_loss = testmodel(model, test_dataloader, "Test")
...
print("The best Weight Decay: ", best_weight_decay)
print("The best Dropout Rate: ", best_dropout)